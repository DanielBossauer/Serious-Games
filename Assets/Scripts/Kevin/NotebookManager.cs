...
public class NotebookManager : MonoBehaviour
{
    ...
    [SerializeField] NotebookTimer timer;
    ...
    public void MakeNotebookAppear()
    {
        ...
        if (timer == null) timer = notebookInstance.gameObject.transform.GetChild(2).GetComponent<NotebookTimer>();

        lerpManager.Rect = notebookInstance;


        Vector3 endPoint = new Vector3(Screen.width*0.5f, Screen.height * 0.2f, 0);
